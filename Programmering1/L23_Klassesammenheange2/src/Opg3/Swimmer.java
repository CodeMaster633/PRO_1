   ...
   public Swimmer(String name, int yearGroup, ArrayList<Double> lapTimes, String club) {
    ...
    public void setTrainingPlan(TrainingPlan trainingPlan) {
        if (this.trainingPlan != trainingPlan) {
            TrainingPlan oldTraningplan = this.trainingPlan;
            if(oldTraningplan!=null){
                oldTraningplan.removeSwimmer(this);
            }
    ...
    public int allTrainingHours () {
        int trainingHours=trainingPlan.getWeeklyStrengthHours()+trainingPlan.getWeeklyWaterHours();
