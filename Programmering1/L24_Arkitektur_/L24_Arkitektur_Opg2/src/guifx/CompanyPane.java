...
public class CompanyPane extends GridPane {
	private TextField txfName, txfHours,txfCust;
	private TextArea txaEmps,txaCust;
	...
	public CompanyPane() {
		...
		this.add(txaCust, 2, 4);
		txaCust.setPrefWidth(200);
		txaCust.setPrefHeight(100);
		txaCust.setEditable(false);
